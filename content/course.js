...
export const lessons = [
  ...
  { slug: 'refunds-chargebacks', title: 'החזרים וחיובים חוזרים', part: 'c', status: 'soon' },
  { slug: 'cash-flow', title: 'תזרים מזומנים', part: 'c', status: 'soon' },

  { slug: 'income-tax', title: 'מס הכנסה', part: 'd', status: 'soon' },
